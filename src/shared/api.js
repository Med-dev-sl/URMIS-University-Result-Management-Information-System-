...
export const uploadDocument = (formData) => apiClient.post('/documents', formData)
...
export const createAssessment = (payload) => apiClient.post('/assessments', payload)
export const fetchRegistrationPeriods = () => apiClient.get('/registration/periods')
export const fetchRegistrations = () => apiClient.get('/registration')
export const createRegistration = (payload) => apiClient.post('/registration', payload)
export const approveRegistration = (registrationId) => apiClient.post(`/registration/${registrationId}/approve`)
export const rejectRegistration = (registrationId, reason = 'Needs revision') => apiClient.post(`/registration/${registrationId}/reject`, { reason })
