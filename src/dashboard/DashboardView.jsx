export default function DashboardView({ dashboard, onViewChange, loading, error }) {
    ...
    <>
      ...
      <section className="panel" style={{ marginBottom: '1rem' }}>
        <div className="panel-header">
          <div>
            <h3>Welcome back</h3>
            <p className="field-hint">Your dashboard summarizes the latest platform activity and student results.</p>
          </div>
        </div>
      </section>
